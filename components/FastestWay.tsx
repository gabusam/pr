...
export default function FastestWay() {
  ...
  const handleClick = (action: string) => {
    trackEvent('button_click', { button: action })
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-24">
          <div>
            ...
            <div className="space-y-4">
              <Button
                ...
                onClick={() => handleClick('install_extension')}
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-2xl p-4 aspect-square" />
            <div className="bg-gray-50 rounded-2xl p-4 aspect-square" />
            <div className="bg-gray-50 rounded-2xl p-4 aspect-square col-span-2" />
          </div>
        </div>
      </div>
    </div>
